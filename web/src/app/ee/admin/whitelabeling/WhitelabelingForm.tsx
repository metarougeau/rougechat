        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving RougeChat for your organization. This will replace 'RougeChat' everywhere in the UI.`}
              placeholder="Custom name which will replace 'RougeChat'"
            ...
            {values.use_custom_logo ? (
              ...
              <SubLabel>
                Specify your own logo to replace the standard RougeChat logo.
              </SubLabel>
            )}
            ...
            <div className="mt-4">
              <TextFormField
                ...
                to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${
                  values.application_name || "RougeChat"
                }!".`}
