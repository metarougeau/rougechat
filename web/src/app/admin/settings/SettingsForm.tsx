      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like RougeChat to retain chat messages. Leaving this field empty will cause RougeChat to never delete chat messages."
